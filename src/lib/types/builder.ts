...
/** 캔버스에 올릴 수 있는 DS 블록 종류 = Assembler `UIElementType` 별칭.
 *  단일 출처: assembler.ts `UI_ELEMENT_TYPES` (ASS-016 re-point — 중복 리터럴 제거).
 *  builder는 표현 레이어로서 같은 종류 집합을 재사용한다(의존 방향 builder→assembler). */
