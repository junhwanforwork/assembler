...
- 시드 구성: 경로 B 싱크-인 API 24개 + DB 테이블 7개(source: code, 이 레포 실측) → 경로 C 생성(opus 1회, 재시도 1회 — 1회차 120s 타임아웃 502) → PUT design 저장
- 그래프: 요구사항 6 · 기능 6 · 페이지 3 · 플로우 1 · 와이어프레임 3 · 엘리먼트 13
